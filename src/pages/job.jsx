...
const JobPage = () => {
  ...
  const {
    loading: loadingHiringStatus, fn: fnHiringStatus} = useFetch(updateHiringStatus, {
      job_id: id,
    })
  ...
  return (
    <div className='flex flex-col gap-8 mt-5'>
      ...
      <SelectTrigger className={`w-full ${job?.isOpen ? "bg-green-900" : "bg-red-950" }`}>
      ...
      <MDEditor.Markdown source={ job?.requirement} className='bg-transparent sm: text-lg'/>
